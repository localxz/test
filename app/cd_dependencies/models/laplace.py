...
def gauss_kernel(channels=3):
    """Creates a Gaussian kernel for blurring, now device-agnostic."""
    kernel = torch.tensor(
        [
            [1.0, 4.0, 6.0, 4.0, 1],
    ...
    # The hardcoded .cuda() call has been removed.
    # The calling function will move the kernel to the correct device.
    return kernel

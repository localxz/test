    ...
    def __init__(self, n_channels_input, n_channels_output):
        ...
        self.double_layer = nn.Sequential(
            AtrousSeparableConvolution(
                in_channels=n_channels_input,
                out_channels=n_channels_output,
                kernel_size=3,
                stride=1,
                padding=1,
                dilation=1,
...
class Downscaling_layer(nn.Module):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        self.layer = nn.Sequential(
            nn.MaxPool2d(2), DoubleConvolutionLayer(input_channels, output_channels)
        )
...
class ExpandingLayer(nn.Module):
    ...
    def __init__(self, input_channels, middle_channels, output_channels):
        ...
        self.downscaling = nn.ConvTranspose2d(
